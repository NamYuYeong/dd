...
<div class="container mt-5 w-50 border shadow p-5">
   ...
   <form action="userJoinOk.do" method="post" name="joinForm">
      ...
      <input type="password" class="form-control mb-2" id="pw" placeholder="비밀번호" name="pw"/>
      <input type="password" class="form-control mb-2" id="pwConfirm" placeholder="비밀번호 확인" name="pwConfirm"/>
      ...
      <input type="text" class="form-control mb-2" id="email" placeholder="이메일" name="email"/>
	  ...
	  <input class="form-control mb-2" type="text" id="sample6_address" name="road_addr" placeholder="주소">
